...
import com.example.oak.searchpill.searchpill.search_TYPE_detail;
...
public class P4_History extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b4_currentpill);
        ...
        try {
            ...
            lisView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                public void onItemClick(AdapterView<?> myAdapter, View myView,
                    ...
                    Intent newActivity = new Intent(P4_History.this,search_TYPE_detail.class);
