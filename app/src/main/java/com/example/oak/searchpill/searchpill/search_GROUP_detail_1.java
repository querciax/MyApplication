 ...
 */
public class search_GROUP_detail_1 extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent newActivity = new Intent(search_GROUP_detail_1.this,search_GROUP_subgroup_1.class);
    ...
    public void showInfo() {
        ...
        String url = "http://medalertapp.comli.com/searchGroup_getByID_1.php";
